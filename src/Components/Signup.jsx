...
const API = 'https://react-tt-api.onrender.com';
...
export default class Signup extends Component {
    ...
    handeleSubmit = (e) => {
        ...
        if (this.state.name.length || 
            ...
            console.log('true')
            axios.post(`${API}/api/users/signup`, {
            ...
            <div className='signup-box'>
                ...
                <div className="signup-right-side">
                    ...
                    <form className='signup-form' onSubmit={this.handeleSubmit}>
                            ...
                            />
                            {/* ERROR MESSAGE */}
                            {this.state.errorMsg && this.state.name.length <= 0 ?  
                                <>
                            ...
                            />
                            {/* ERROR MESSAGE */}
                            {this.state.errorMsg && this.state.password != this.state.confirm_password ? 
                                <>
